...
const products=[
    {
       imageSource:'images/products/athletic-cotton-socks-6-pairs.jpg',
    ...
    {
        imageSource:'images/products/intermediate-composite-basketball.jpg',
     ...
     {
        imageSource:'images/products/adults-plain-cotton-tshirt-2-pack-teal.jpg',
...
products.forEach((products)=>{
    ...
    const productsHTML=`<div class="product-container">
            <div class="product-image-container">
              <img class="product-image" src="${products.imageSource}">
            </div>
